...
function Financial(){const vehicle={id:'UI-V',plate:'TEST-974',model:'Fourgon de test',status:VehicleStatus.ACTIVE,mileage:13000};const logs=[{id:'1',date:'2026-07-31',mileage:10000,volume:10,cost:18},{id:'2',date:'2026-08-31',mileage:11000,volume:100,cost:180},{id:'3',date:'2026-09-12',mileage:13000,volume:150,cost:270}].map(l=>({...l,vehicleId:'UI-V',userId:user.id}));return <main className="p-4"><Dashboard currentUser={{...user,role:UserRole.PRESIDENT}} vehicles={[vehicle]} logs={logs} maintenanceLogs={[]} issues={[]} users={[user]} onNavigate={(...args)=>window.__calls.push(args)}/></main>}
