...
export const DEFAULT_ROLE_TEMPLATES: Record<UserRole, PermissionKey[]> = {
  [UserRole.PRESIDENT]: [
    ...
    Permission.DASHBOARD_KPI_FUEL_COSTS,
    Permission.DASHBOARD_KPI_MAINTENANCE,
    Permission.DASHBOARD_KPI_MAINTENANCE_COSTS,
    Permission.DASHBOARD_KPI_HR,
    Permission.DASHBOARD_KPI_FINANCIAL,
    Permission.DASHBOARD_ALERTS_DOCUMENTS,
    ...
    Permission.MAINTENANCE_VIEW_COSTS,
